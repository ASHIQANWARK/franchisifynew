    ...
    <div className="bg-white text-gray-900 min-h-screen font-sans">
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-black to-gray-800 py-20 lg:py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Invest in premium jewellery and luxury retail franchise opportunities
          </motion.p>
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: 0.4 }}
            className="w-24 h-1 bg-gradient-to-r from-yellow-500 to-amber-500 mx-auto mt-8 rounded-full"
          />
        </div>
      </section>
      ...
      <nav className="bg-gray-50 border-b border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-900 font-semibold">Jewellery Franchises</span>
          </div>
        </div>
      </nav>
